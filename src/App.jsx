      ...
      <div className={`w-full md:flex md:items-center md:w-auto ${isOpen ? 'block' : 'hidden'}`}>
        <ul className="flex flex-col md:flex-row md:space-x-4">
          {['home', 'skills', 'projects', 'contact'].map((item) => (
            <li
              key={item}
              className={`p-2 cursor-pointer ${activeSection === item ? 'text-[#cf3443] font-bold' : 'hover:text-[#cf3443]'}`}
        ...
        <div>
          <div className="flex flex-col justify-between lg:flex-row p-10">
            <div className="flex items-center justify-center pb-4">
              <img src="src/assets/image.png" alt="image" className="rounded-full border object-cover w-80 h-80 " />
            </div>
        ...
        <div id="skills" className="pb-6 mb-4">
          <div className="bg-white rounded-md flex items-center justify-center p-8">
            <div className="max-w-5xl w-full mx-auto">
              <h1 className="text-4xl text-center text-[#7a141e] mb-12 font-bold">
                My Skills
              </h1>
        ...
        <div id="projects" className="mb-20">
          <h1 className="text-center font-bold text-4xl mb-10 text-[#7a141e]">Projects</h1>
        ...
        >
          <h2 className="text-center font-bold text-4xl text-[#7a141e] mb-10">
            Contact Me
          </h2>
          <div className=" flex flex-wrap justify-center gap-10 ">
          <div className="">
            <img src="src/assets/Messages-rafiki.svg" alt="" className="w-96 h-25"/>
          </div>
          <div className="w-96">
